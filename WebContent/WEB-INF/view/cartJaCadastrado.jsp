		...
		<div id="divContainer">
			...
			<c:choose>
					...
					<c:if test="${not empty pedido and pedido.getListaPedidos().size() > 0}">
						...
						<c:forEach var="itemPedido" items="${pedido.listaPedidos}">
						    ...
						    <div class="divCartItem">
						    	...
						    	<input readonly type="text" id="produtoQuantidade" class="inputCartItemQuantidade" value="${itemPedido.quantidade}" maxlength="2" max="99">
						...
						<div id="actions" class="row">
		                    <div class="col-md-12">
		                        <a href='verPedidos' class="btn btn-dark">Voltar</a>
		                    </div>
		                </div>
					</c:if>
				...
				<c:otherwise>
					...
					<div class="divCartItem">
				        <a href="<spring:url value='/login' />">Vamos nos logar?</a>
				    </div>
